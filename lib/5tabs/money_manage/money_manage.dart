...
import 'package:creeasy/components/appbar/common_appbar_comp.dart';
import 'package:creeasy/components/mini_info/mini_info.dart';
import 'package:auto_size_text/auto_size_text.dart';
import 'package:creeasy/5tabs/money_manage/pay_history_tile_comp.dart';
...
class _MoneyManagePageState extends State<MoneyManagePage> with SingleTickerProviderStateMixin {
  List<Map<String, dynamic>> _payHistories = [
    {'payDate': DateTime(2024, 9, 5), 'payPlace': 'セブン', 'payCardName': '三井住友カード', 'connectBank': '三菱UFJ銀行', 'payPrice': 392, 'isSetureMoney': false},
