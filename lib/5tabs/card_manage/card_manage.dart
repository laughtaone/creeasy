...
import 'package:creeasy/5tabs/card_manage/add_card/add_card_main.dart';
import 'package:creeasy/5tabs/card_manage/card_manage_card-tile.dart';
import 'package:creeasy/5tabs/card_manage/card_manage_bank-tile.dart';
...
import 'package:creeasy/5tabs/card_manage/bank_example_icon.dart';
import 'package:creeasy/5tabs/status/status_fundbox_tile_comp.dart';
            ...
            Padding(
              ...
              child: ListView(
                children: [
                  ...
                  const CardManageBankTile(recvBankName: 'みんなの銀行 - 専用ボックス', recvBankType: 1),
